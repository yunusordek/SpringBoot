package com.workSpace.api;

import com.workSpace.entity.Kullanici;
import com.workSpace.repository.KullaniciRepository;
...
public class KullaniciApi {
    ...
    public void init(){
        ...
        kullanici.setAdi("Yunus");
        kullanici.setSoyadi("Ordek");
    ...
    @GetMapping
    public ResponseEntity<List> tumunuListele() {
